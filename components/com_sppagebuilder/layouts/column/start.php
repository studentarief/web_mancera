...
$html  = '';
$html .= '<div class="sppb-' . $options->cssClassName . ''.$column_order.' ' . $custom_class . '" id="column-wrap-id-'. $options->dynamicId .'">';
$html .= '<div id="column-id-'. $options->dynamicId .'" class="sppb-column" ' . $data_attr . '>';
